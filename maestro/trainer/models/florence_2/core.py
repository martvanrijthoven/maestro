...
class Florence2Configuration:
    ...
    Attributes:
        ...
        limit_train_batches (Optional[int | float]):
            Maximum number of training batches per epoch (int) or fraction of dataset (0.0-1.0 float). If None, trains for full epochs.
        limit_val_batches (Optional[int | float]):
            Maximum number of validation batches per epoch (int) or fraction of dataset (0.0-1.0 float). If None, uses all validation data.
    """
